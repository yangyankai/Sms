...

{
	...
	private static String APPKEY = "a4949eb8ef00";

	// 填写从短信SDK应用后台注册得到的APPSECRET
	private static String APPSECRET = "2fd9ab94509675dd98dde18fb05984a5";
			...
			public void onClick(View v)
			{
				if (v.getId() == R.id.btn_dialog_ok)
				{
					...
					if (TextUtils.isEmpty(APPKEY) || TextUtils.isEmpty(APPSECRET)) {
						Toast.makeText(v.getContext(), R.string.smssdk_appkey_dialog_title, Toast.LENGTH_SHORT).show();
					} else {
						dialog.dismiss();
						setSharePrefrence();
						initSDK();
